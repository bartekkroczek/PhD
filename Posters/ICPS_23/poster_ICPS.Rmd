...
affiliation:
  - num: 1
    address: Neurocognitive Processing Laboratory, Department of Cognitive Science, Jagiellonian University, Krakow, Poland
column_numbers: 3
logoright_name: media/logo_kogni_transparent.png
logoleft_name: media/logo_uj_transparent.png
logocenter_name: media/logo_uj_transparent.png
title_textsize: "65pt"
main_textsize: "150pt"
main_findings:  Varying **cue-stimulus** interval **marginally affects** the sensory **discrimination performance** in the **antisaccade** task
output: 
...
sample. Both data sets were analyzed in the same way.
...
```{r fig.width=10.7, fig.height=5.5}
data.B.aggr |> 
...
The colored curves represents beta variable distribution for <span style="color:#a1c549">bigger low-res</span> and <span style="color:#ce8dff">smaller high-res</span> datasets respectively. 
Both curves did not show evidence of non-normality and are showing significant difference from a zero distribution (**p<.001**).
However, both effects are, in our opinion, negligibly small (<span style="color:#a1c549">4.15 pp </span> and <span style="color:#ce8dff">4.58 pp </span> of increased avg. accuracy over 1000 ms).  
...
```{r}
per.data <- tribble(~ "Frequency [in Hz]", ~ Estimate, ~ "p value", ~ "p adjusted",
        0, 0.086, .85, ">.99",
        1.277,0.435,.3, ">.99",
        2.553,0.612,.99,"> .99",
        3.83,0.661,.76,"> .99",
